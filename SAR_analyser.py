...
if selected == "Home":
    ...
    if uploaded_file is not None:
        ...
        nan_counts.columns = ['Column', 'Count']
        ...
        if len(numeric_cols) > 1:
            ...
            st.write("Not enough numerical columns to compute correlation heatmap.")
        ...
        if len(numeric_cols) >= 2:
            ...
            st.write("Not enough numerical columns to plot regression.")
        ...
        st.subheader("Filter molecules by property range")
